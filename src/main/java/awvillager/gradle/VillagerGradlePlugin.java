...
public class VillagerGradlePlugin implements Plugin<Project> {
    ...
    public void apply(Project arg0) {
        ...
        // ext = project.getExtensions().create(EXTENSIONS_AIWOLF,
        // AWExtension.class,project);

        // project.getExtensions().add(EXTENSIONS_AIWOLF, AWExtension.class);

        // AWExtension ext = (AWExtension)
        // project.getExtensions().getByName(EXTENSIONS_AIWOLF);
        ...
        project.getGradle().addListener(new DependencyResolutionListener() {
            ...
            public void beforeResolve(ResolvableDependencies resolvableDependencies) {
                ...
                compileDeps.add(project.getDependencies().add("compile", ":aiwolf_common:" + version));
                compileDeps.add(project.getDependencies().add("compile", ":aiwolf_client:" + version));
                compileDeps.add(project.getDependencies().add("compile", ":aiwolf_server:" + version));
                compileDeps.add(project.getDependencies().add("compile", ":aiwolf_viewer:" + version));
        ...
        // project.getTasks().getByName(JavaPlugin.JAVADOC_TASK_NAME);
